...
const Project = () => { 
    ...
    const projects = [
        ...
        { id: 4, image_url:(Cars), title: 'Full Stack - Cars', subtitle: "REACT, JAVA", description:"I built and designed a Full stack App where I could Add, update and delete my favourite cars. This was a fun project where I could show off all of my skills.", code_url:"https://github.com/Chelsealily/full-stack-project", preview_url:"https://github.com/Chelsealily/full-stack-project" },
        { id: 5, image_url:(Tick), title: 'Ticket Tracker', subtitle: "REACT", description:"This was one of my earlier REACT TS projects where I created a functioning ticket tracker so that each employee could track their own tickets", code_url:"https://github.com/Chelsealily/ticket-tracker", preview_url:"https://chelsealily.github.io/ticket-tracker/" },
        { id: 6, image_url:(Pokemon), title: 'Pokemon', subtitle: "JAVASCRIPT", description:"This was my first ever technical timed test project using React TS and an API. I rendered a list of 150 cards from an API to show various pokemon characters", code_url:"https://github.com/Chelsealily/pokedom-index", preview_url:"https://chelsealily.github.io/pokedom-index/" },
        { id: 7, image_url:(Todo), title: 'To do List', subtitle: "REACT", description:"This was a timed technical test project using React TS where I created a functioning to do list within a 3 hour time limit, you can add, check and delete a task!", code_url:"https://github.com/Chelsealily/todo-list", preview_url:"https://chelsealily.github.io/todo-list/" },
